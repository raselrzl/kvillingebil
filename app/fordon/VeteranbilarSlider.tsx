  ...
  if (!vehicles || vehicles.length === 0) {
    return (
      <div className="w-full flex justify-center items-center py-20 px-4">
        <div className="relative max-w-xl w-full rounded-3xl p-[1px] bg-gradient-to-br from-[#2db1cc]/40 via-transparent to-[#36b795]/40">
          <div className="rounded-3xl bg-white/80 backdrop-blur-xl border border-white/40 shadow-2xl p-10 text-center">
            {/* Accent line */}
            <div className="w-12 h-1 mx-auto mb-6 rounded-full bg-gradient-to-r from-[#2db1cc] to-[#36b795]" />
