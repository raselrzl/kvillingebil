...
const VehicleCard: React.FC<VehicleCardProps> = ({
  ...
  return (
    <div className="relative overflow-hidden shadow-2xl hover:shadow-3xl transition cursor-pointer group h-100 md:h-110">
      <Image
        src={image}
        alt={title}
        fill
      ...
      {link && (
        <div className="absolute bottom-4 right-4">
          <Link href={link}>
            <button className="bg-black/50 hover:bg-[#208195] text-white px-2 py-1 rounded-full font-semibold text-xs shadow-md transition">
              Se detaljer
            </button>
          </Link>
        </div>
