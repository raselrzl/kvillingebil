    ...
    <>
      ...
      <section className="relative w-full h-130 sm:h-150 lg:h-175 flex items-center justify-center bg-linear-to-r from-gray-900 via-black to-gray-900">
        ...
        >
          ...
          <p className="mt-4 text-sm sm:text-base md:text-lg opacity-80 max-w-xl mx-auto">
            Boka din husbil eller husvagn för professionell service och reparation. Vi tar hand om allt!
          </p>
        </motion.div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative w-full h-96 sm:h-120 lg:h-130">
            <div className="absolute top-0 left-0 w-[80%] h-[80%] rounded-3xl overflow-hidden shadow-2xl transform -rotate-3">
              <Image src="/workshop.jpeg" alt="Workshop 1" fill className="object-cover" />
            </div>
            <div className="absolute bottom-0 right-0 w-[80%] h-[80%] rounded-3xl overflow-hidden shadow-2xl border-4 border-white transform rotate-3">
              <Image src="/22.jpg" alt="Workshop 2" fill className="object-cover" />
            </div>
          </div>
          ...
          >
            ...
            <p className="text-gray-700 text-base leading-relaxed">
              Som återförsäljare av KAMA fritid hjälper vi dig med beställning av reservdelar och tillbehör.
            </p>
            <p className="text-gray-700 text-base leading-relaxed">
              Vår verkstad erbjuder fullservice för att hålla ditt fordon i toppskick  tryggt, enkelt och effektivt.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="relative w-full py-24 bg-linear-to-r from-gray-900 via-black to-gray-900">
        <div className="absolute inset-0">
          <Image src="/workshop1.png" alt="CTA Background" fill className="object-cover opacity-50" />
